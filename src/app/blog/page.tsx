          ...
          >
            ...
            <div className="flex flex-col text-start">
              ...
              <p className="mt-2 text-gray-600">
                This is a short description or paragraph about the content of
                the card.
              </p>

              {/* Button */}
              <button className="hover:bg-brown-700 mt-4 w-full rounded-md bg-brown px-6 py-2 text-white sm:w-2/3">
                Learn More
              </button>
            </div>
          </div>
