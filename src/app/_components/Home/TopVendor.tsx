    ...
    <div className="mb-bom">
      ...
      <div className="mx-auto flex flex-col flex-wrap items-center justify-center gap-6 sm:w-full sm:flex-row">
        {HomeDatas.Vendors.map((datas) => (
          <div
            key={datas.id}
            className="flex max-w-60 flex-col items-center justify-center gap-4 rounded-lg border p-4 shadow-md transition-transform duration-200 hover:scale-105 hover:bg-bgDeep/20 hover:shadow-lg"
          >
            <Image
              src={datas.img}
