...
const MeetTeam = () => {
  return (
    <div className="mb-bom flex flex-col items-center justify-center rounded-md bg-[#162b40] p-10 px-3 py-2 pt-[1.5rem] text-center text-white">
      ...
      {/* <div className="mb-[3rem] mt-7 hidden items-center justify-center gap-7 text-center sm:flex sm:flex-row md:mb-[4rem]">
        {HomeDatas.Staffs.map((data, i) => (
          <div
            key={i}
            className={`relative flex w-full flex-col items-center justify-center gap-y-[0.3rem] transition-transform duration-300 hover:scale-105 ${i === 1 || i === 3 ? "sm:mt-[5rem]" : ""}`}
